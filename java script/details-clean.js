...
function updateDetailsPage() {
    ...
    const book = library.find(b => b.id === 'clean'); 
    ...
    if (book.status === 'Borrowed') {
        ...
        button.style.backgroundColor = "orange"; // Optional: make it look different
        
        // Change what happens when clicked (Return logic)
        form.onsubmit = function(e) {
            e.preventDefault();
            returnThisBook('clean', library);
        };
    } else {
